...
Test::More is no longer under active development. This module has been
locked against all but critical maintenance. New features will no longer be
added, and some known bugs will never be fixed.

=head2 WHY?

Test::More has been around for a very long time, and in recent years has
seen very little code churn. At this point there are a lot of modules that
depend on Test::More working the way it does, bugs and all. Many cpan
...
Test::More. Several of these efforts failed simply because there is too much
at stake. Even fixing some bugs has the potential to break large chunks of
cpan, or darkpan code.

At this point updating Test::More is not a viable option.
